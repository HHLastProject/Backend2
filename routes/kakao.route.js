...
/////////////////////////////////////////////       내id 내로컬url
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/login4", async (req, res) => {
  const { code } = req.body;
  const data = {
    grant_type: "authorization_code",
    client_id: "92e15ddd07c08d5fd1734a941c3f539c",
...
/////////////////////////////////////////////       내id 내 원격url
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/login5", async (req, res) => {
  const { code } = req.body;
  const data = {
    grant_type: "authorization_code",
    client_id: "92e15ddd07c08d5fd1734a941c3f539c",
    redirect_uri: "http://54.180.105.213/api/kakao/login",
    code,
  };
...
/////////////////////////////////////////////       내id 프론트 url
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/login6", async (req, res) => {
  const { code } = req.body;
  const data = {
    grant_type: "authorization_code",
    client_id: "92e15ddd07c08d5fd1734a941c3f539c",
...
///////////////////////////////////////  프론트 id   내 url
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/login7", async (req, res) => {
  const { code } = req.body;
  const data = {
    grant_type: "authorization_code",
...
///////////////////////////////////////프론트 id   내 원격 url
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/login8", async (req, res) => {
  const { code } = req.body;
  const data = {
    grant_type: "authorization_code",
    client_id: "552308e28dcc9e6296fed9c2a196525e",
...
/////////////////////////////////////// 프론트 id   프론트 url
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
router.get("/login9", async (req, res) => {
  const { code } = req.body;
  const data = {
    grant_type: "authorization_code",
    client_id: "552308e28dcc9e6296fed9c2a196525e",
